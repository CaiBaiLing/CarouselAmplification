...
- (void)viewDidLoad {
    ...
    //图片组
    for (int i = 0; i < 50; i++) {
        [mImages addObject:@"http://img.corp.com/group1/M00/01/5D/wKgB-lesKdKAH4tdAACiSQ8e9Co296.jpg"];
    }
    
    UICollectionViewFlowLayout *layout = [[UICollectionViewFlowLayout alloc] init];
    colView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 64, kScreenWidth, kScreenHeight-49-64) collectionViewLayout:layout];
    [colView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:@"myCell"];
    colView.backgroundColor = [UIColor cyanColor];
